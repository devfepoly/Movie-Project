                ...
                <div className="flex justify-between items-center h-24">
                    ...
                    <div className="hidden md:flex items-center space-x-12">
                        {navLinks.map((link) => (
                            <Link
                                key={link.path}
                                to={link.path}
                                className={`relative px-2 py-2 text-base font-medium transition-all duration-300 ${isActive(link.path)
                                    ? 'text-pink-500'
                    ...
                    <div className="hidden lg:flex items-center gap-6">
                        ...
                        <div className="relative shrink-0 group">
                            <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full opacity-0 group-hover:opacity-100 blur-lg transition-opacity duration-500"></div>
                            <div className="relative flex items-center">
                                ...
                                />
                                <button className="absolute right-3 p-1.5 text-gray-500 hover:text-pink-500 hover:bg-pink-500/10 rounded-full transition-all duration-300">
